...
class SubjectOverviewElement(Frame):
    ...
    def editMenu(self, parent):
        ...
        self.edit_grades_btn = ttk.Button(btn_frame, text="Noten editieren", command=lambda: GradeEditor(self.window, self.subject, self.notensys))
        self.edit_grades_btn.pack(side=LEFT, padx=(5, 5), pady=5)
